/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fb77c02e6ac740071b538be77e527ba0)
...
interface __BaseEnv_Env {
	...
	RATE_LIMIT_SUBTITLE_MAX_REQUESTS: "40";
	TMDB_TOKEN: string;
	OMDB_API_KEY: string;
	APP_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "CORS_ORIGIN" | "RATE_LIMIT_WINDOW_MS" | "RATE_LIMIT_MAX_REQUESTS" | "RATE_LIMIT_SUBTITLE_MAX_REQUESTS" | "TMDB_TOKEN" | "OMDB_API_KEY" | "APP_SECRET" | "FANART_API_KEY" | "SUBDL_API_KEY">> {}
}
